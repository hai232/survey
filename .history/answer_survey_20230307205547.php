			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body p-0 py-2">
					<div class="container-fluid">
						<p>Tên: <b><?php echo $stitle ?></b></p>
						<p class="mb-0">Chú thích:</p>
			...
			<div class="card card-outline card-success">
				...
				<div class="card-footer border-top border-success">
					<div class="d-flex w-100 justify-content-center">
						<button class="btn btn-sm btn-flat bg-gradient-primary mx-1" form="manage-survey">Cung cấp câu trả lời</button>
						<button class="btn btn-sm btn-flat bg-gradient-secondary mx-1" type="button" onclick="location.href = 'index.php?page=survey_widget'">Thoát</button>
					</div>
				</div>
			</div>
		</div>
