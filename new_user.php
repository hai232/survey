		...
		<div class="card-body">
			<form action="" id="manage_user">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<b class="text-muted">Thông tin hệ thống</b>
						...
						<div class="form-group">
							...
							<select name="chuc_vu" id="chuc_vu" class="custom-select custom-select-sm">
								...
								<option value="3" <?php echo isset($chuc_vu) && $chuc_vu == 3 ? 'selected' : '' ?>>Giảng viên</option>
								<option value="2" <?php echo isset($chuc_vu) && $chuc_vu == 2 ? 'selected' : '' ?>>Sinh viên</option>
