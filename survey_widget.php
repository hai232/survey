...
<div class="col-lg-12">
	...
	<div class="row">
		<?php 
		$survey = $conn->query("SELECT * FROM khao_sat where '".date('Y-m-d')."' between date(ngay_bat_dau) and date(ngay_ket_thuc) order by rand() ");
               ...
               <div class="row">
               	...
               	<div class="d-flex justify-content-center w-100 text-center">
               		<?php if(!isset($ans[$row['id']])): ?>
               			<a href="index.php?page=answer_survey&id=<?php echo $row['id'] ?>" class="btn btn-sm bg-gradient-primary"><i class="fa fa-pen-square"></i>Đi khảo sát</a>
               		<?php else: ?>
               			<p class="text-primary border-top border-primary">Hoàn thành</p>
               		<?php endif; ?>
               	</div>
               </div>
              </div>
